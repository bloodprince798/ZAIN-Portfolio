...
if (contactForm) {
    contactForm.addEventListener('submit', function(event) {
        ...
        alert('Thank you ' + name + '! I will contact you soon at ' + email);
...
window.addEventListener('scroll', function() {
    ...
    if (window.scrollY > 100) {
        header.style.background = 'rgba(2, 70, 49, 0.95)';
    } else {
        header.style.background = '#024631';
    }
});
...
for (var i = 0; i < skillItems.length; i++) {
    skillItems[i].addEventListener('mouseover', function() {
        ...
        this.style.backgroundColor = '#024631';
    });
    
    skillItems[i].addEventListener('mouseout', function() {
        this.style.transform = 'scale(1)';
        this.style.backgroundColor = 'rgb(3, 105, 75)';
    });
}
